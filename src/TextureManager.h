...
public:
	...
	void draw(const std::string& id, int x, int y, double angle, int alpha ,SDL_RendererFlip flip, int dstx, int dsty);
	void TextureManager::draw(const std::string& id, SDL_Rect srcRect, double angle, int alpha, SDL_RendererFlip flip, SDL_Rect destRect);
