...
void victoryScene::handleEvents()
{
...
void victoryScene::start()
{
	...
	m_label = new Label("VICTORY!!", "Dock51", 80, red, glm::vec2(Config::SCREEN_WIDTH * 0.5, Config::SCREEN_HEIGHT * 0.4));
